...
[charmbracelet/vhs](https://github.com/charmbracelet/vhs). The tape seeds a
throwaway demo database at `/tmp/golearn-demo.db` from a bundled pack, so the
recording is deterministic and never touches your real `~/.golearn` data.
